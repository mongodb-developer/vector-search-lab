...
|Lab goals|Go from a vector search beginner to pro|
|:-|:-|
|What you'll learn|What is vector search?|
||How vector search works|
||Perform vector search queries using MongoDB Vector Search|
||Ways to optimize your vector search queries|
