...
<Screenshot url="https://github.com/codespaces" src="img/screenshots/30-dev-env-setup/2-dev-env-setup/1-create-codespace.png" alt="Start a codespace" />
...
<Screenshot url="https://github.com/codespaces" src="img/screenshots/30-dev-env-setup/2-dev-env-setup/2-nav-notebook.png" alt="Navigate to the notebook" />

Next, select the Python interpreter by clicking **Select Kernel** at the top right of the IDE.

<Screenshot url="https://github.com/codespaces" src="img/screenshots/30-dev-env-setup/2-dev-env-setup/3-select-kernel.png" alt="Select kernel" />
...
<Screenshot url="https://github.com/codespaces" src="img/screenshots/30-dev-env-setup/2-dev-env-setup/4-python-env-modal.png" alt="Select Python Environments" />

<Screenshot url="https://github.com/codespaces" src="img/screenshots/30-dev-env-setup/2-dev-env-setup/5-select-recommended.png" alt="Select recommended interpreter" />
...
<Screenshot url="localhost:8888/tree" src="img/screenshots/30-dev-env-setup/2-dev-env-setup/6-jupyter-notebook.png" alt="Jupyter Notebook" />
