...
The passkey provided to you during the workshop will be valid for 3 days after the workshop. Once the passkey expires, or if you weren't at a MongoDB Developer Day, you will need to obtain a Voyage AI API key of your own for the workshop.
