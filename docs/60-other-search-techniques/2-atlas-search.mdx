...
Refer to our [documentation](https://www.mongodb.com/docs/atlas/atlas-search/?utm_campaign=devrel&utm_source=workshop&utm_medium=cta&utm_content=genai_dev_day_docs&utm_term=apoorva.joshi) to learn more about MongoDB Search.