...
You can verify that embeddings have been added to the documents in the `books` collection using the Atlas UI:

<Screenshot url="https://cloud.mongodb.com" src="img/screenshots/30-perform-semantic-search/2-add-embeddings/1-verify-collection.png" alt="Verify collection" />