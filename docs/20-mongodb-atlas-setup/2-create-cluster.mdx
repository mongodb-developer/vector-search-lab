...
<Screenshot url="https://cloud.mongodb.com" src="img/screenshots/20-mongodb-atlas-setup/2-create-cluster/1-overview.png" alt="Overview screenshot" />
...
<Screenshot url="https://cloud.mongodb.com" src="img/screenshots/20-mongodb-atlas-setup/2-create-cluster/2-deploy-database.png" alt="Create cluster screenshot" />
...
<Screenshot url="https://cloud.mongodb.com" src="img/screenshots/20-mongodb-atlas-setup/2-create-cluster/3-database-deployment.png" alt="Create cluster screenshot" />