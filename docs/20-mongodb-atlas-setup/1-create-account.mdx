...
<details>
  <summary> 🦹‍♀️ If you already have an Atlas account, you can use it by creating a new project.</summary>
    ...
    <Screenshot url="https://account.mongodb.com" src={"img/screenshots/20-mongodb-atlas-setup/1-create-account/3-login.png"} alt="Login form" />
    ...
    <Screenshot url="https://cloud.mongodb.com" src={"img/screenshots/20-mongodb-atlas-setup/1-create-account/4-new-project.png"} alt="Create new project" />

    Enter a name for your project and click **Next**.

    <Screenshot url="https://cloud.mongodb.com" src={"img/screenshots/20-mongodb-atlas-setup/1-create-account/5-new-project-name.png"} alt="Create new project" />
...
<Screenshot url="https://cloud.mongodb.com" src={"img/screenshots/20-mongodb-atlas-setup/1-create-account/1-form.png"} alt="Account creation form" />
...
<Screenshot url="https://cloud.mongodb.com" src={"img/screenshots/20-mongodb-atlas-setup/1-create-account/2-verify-email.png"} alt="Verify your email address" />
