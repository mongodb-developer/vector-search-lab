...
Fill in any `<CODE_BLOCK_N>` placeholders and run the cells under the **Step 8: Enable vector quantization** section in the notebook to enable auto-quantization on your embeddings.
